...
// 购物车中所有被选中的商品
const allCheckedShopInfos = cartStore.getAllCheckedGoodsList()
...
const onSubmit = async () => {
  ...
  for (let [key, value] of allCheckedShopInfos) {
    orderList.push({
  ...
  cartStore.clearAllCheckedGoodsList()
...
<template>
  <div class="order-comfirmation-page">
    <div class="order-comfirmation-page__main">
      ...
      <template v-for="data in allCheckedShopInfos" :key="data[0]">
        <OrderList :data="data[1]" :show="false"></OrderList>
      </template>
